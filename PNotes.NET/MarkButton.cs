...
namespace PNotes.NET
{
    ...
    public enum ToolStripButtonSize
    {
        Normal = 12,
        Large = 16
    }

    public class MarkButton : Button
    {
        ...
        static MarkButton()
        {
            DefaultStyleKeyProperty.OverrideMetadata(typeof(MarkButton), new FrameworkPropertyMetadata(typeof(MarkButton)));
            ButtonTypeProperty = DependencyProperty.Register("ButtonType", typeof(MarkType),
                typeof(MarkButton),
                new FrameworkPropertyMetadata(MarkType.Schedule, OnButtonTypeChanged));
        ...
        public MarkType ButtonType
        {
            get { return (MarkType)GetValue(ButtonTypeProperty); }
